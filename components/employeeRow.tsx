...
export default function EmployeeRow(employee: Employee) {
  ...
  return (
    <tr
      ...
      className=" shadow-pink-950 shadow-lg rounded-xl "
    >
      <td className="">
        <Image
        ...
        ></Image>
        <b className="pl-14">
          {(employee.daysToBirthday == 0 ? "🎂 " : "").concat(
            titleCase(employee.firstName).toString()
          )}
        </b>
      </td>
      <td>
        <b> {titleCase(employee.lastName)} </b>{" "}
      </td>
      ...
      <td>
        <button
          ...
          className="border p-3 rounded-xl border-pink-950 hover:bg-pink-950"
        >
          Details
        </button>
      </td>
